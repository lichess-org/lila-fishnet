...
libraryDependencies += "io.lettuce"   % "lettuce-core"                 % "6.0.3.RELEASE"
libraryDependencies += "io.netty"     % "netty-transport-native-epoll" % "4.1.60.Final" classifier "linux-x86_64"
