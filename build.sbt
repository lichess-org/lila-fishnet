...
libraryDependencies += "io.lettuce"   % "lettuce-core"                 % "6.0.1.RELEASE"
libraryDependencies += "io.netty"     % "netty-transport-native-epoll" % "4.1.53.Final" classifier "linux-x86_64"
